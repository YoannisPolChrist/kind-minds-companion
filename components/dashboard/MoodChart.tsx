    ...
    >
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          <View>
            ...
            <Text style={{ fontSize: 24, fontWeight: '900', color: '#fff', letterSpacing: -0.5 }}>
              {activePoint.value}
              <Text style={{ fontSize: 14, fontWeight: '600', color: 'rgba(255,255,255,0.5)' }}> /10</Text>
            </Text>
          ...
          <View style={{ alignItems: 'flex-end', gap: 6 }}>
            ...
            <Text style={{ fontSize: 11, color: 'rgba(255,255,255,0.35)', fontWeight: '600' }}>
              Durchschnitt {avgMood.toFixed(1)} / 10
            </Text>
          </View>
        </View>
      </View>
      ...
      <View style={{ flexDirection: 'row', paddingHorizontal: 24, paddingBottom: 20, paddingTop: 4, gap: 12 }}>
        {[
          ...
          { label: 'Mittel', value: Number(avgMood.toFixed(1)), color: TEAL },
          ...
          >
            <Text style={{ fontSize: 18, fontWeight: '900', color: stat.color }}>
              {stat.value}
              <Text style={{ fontSize: 12, fontWeight: '600', color: 'rgba(255,255,255,0.4)' }}>/10</Text>
            </Text>
