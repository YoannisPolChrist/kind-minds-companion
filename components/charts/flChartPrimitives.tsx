...
const DEFAULT_TEXT = '#243842';
const DEFAULT_SUBTLE = '#6B7C85';
const DEFAULT_GRID = 'rgba(148, 163, 184, 0.18)';
    ...
    return (
      <View style={{ width: size, alignItems: 'center' }}>
        <Svg width={size} height={size}>
          <Circle cx={radius} cy={radius} r={radius - 12} fill={withAlpha('#CBD5E1', 0.22)} />
