...
interface AppState {
    ...
    preferredCalendarProvider: CalendarProvider;
    setPreferredCalendarProvider: (provider: CalendarProvider) => void;
...
export const useAppStore = create<AppState>()(
    persist(
        (set) => ({
            ...
            preferredCalendarProvider: 'device',
            setPreferredCalendarProvider: (provider) => set({ preferredCalendarProvider: provider }),
