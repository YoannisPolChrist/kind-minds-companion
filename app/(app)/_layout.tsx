...
export default function AppLayout() {
    ...
    if (profile?.role === 'therapist') {
        return (
            <Stack screenOptions={{ headerShown: false }}>
                ...
                <Stack.Screen name="therapist/clients" />
                <Stack.Screen name="therapist/resources" />
                <Stack.Screen name="therapist/templates" />
                <Stack.Screen name="therapist/template/[id]" />
                <Stack.Screen name="therapist/client/[id]" />
                <Stack.Screen name="therapist/client/[id]/resources" />
                <Stack.Screen name="therapist/client/[id]/files" />
                <Stack.Screen name="therapist/client/[id]/notes" />
                <Stack.Screen name="therapist/client/[id]/checkins" />
                <Stack.Screen name="therapist/client/[id]/exercises" />
            </Stack>
        );
    }
    ...
    return (
        <Stack screenOptions={{ headerShown: false }}>
            ...
            <Stack.Screen name="checkins_overview" />
            <Stack.Screen name="exercises_overview" />
