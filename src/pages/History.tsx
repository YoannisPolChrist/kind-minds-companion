  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        const all = [...exercises, ...checkins].sort(
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-2xl mx-auto px-5 py-6 space-y-6">
        {items.length === 0 ? (
          ...
          grouped.map(([weekStart, weekItems], gi) => (
            <div key={weekStart} className="animate-slide-up" style={{ animationDelay: `${gi * 80}ms` }}>
              ...
              <div className="space-y-2.5 pl-4 border-l-2 border-border">
                {weekItems.map((item) => (
                  <div
                    ...
                    onClick={() => {
                      if (item.type === "exercise") navigate(`/exercise/${item.id}`);
                      else navigate("/checkins");
                    }}
                  >
