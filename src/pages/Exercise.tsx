...
const InteractiveChartBlock = lazy(() => import("../components/exercise/InteractiveChartBlock"));
  ...
  switch (block.type) {
    ...
    case "line_chart":
      return (
        ...
        >
          <InteractiveChartBlock block={block} value={value} onChange={onChange} disabled={disabled} />
        </Suspense>
      );
...
export default function Exercise() {
  ...
  const handleDownloadPdf = useCallback(() => {
    if (!exercise) return;
    generateExercisePdf({ ...exercise, answers });
  }, [exercise, answers]);
